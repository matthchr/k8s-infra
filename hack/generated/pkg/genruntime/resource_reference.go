...
type ResourceReference struct {
	...
	ARMID string `json:"armId"` // TODO: Note that the pattern for this field is NOT case insensitive... technically we should be but it makes the pattern absolutely terrible [Ss][Uu][Bb][Ss]...
}
