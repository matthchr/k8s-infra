...
const (
	reflectHelpersPath = "github.com/Azure/k8s-infra/hack/generated/pkg/reflecthelpers"
)
...
var (
	...
	ReflectHelpersReference PackageReference = MakeExternalPackageReference(reflectHelpersPath)
