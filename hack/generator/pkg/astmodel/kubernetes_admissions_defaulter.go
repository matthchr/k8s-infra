...
type DefaulterBuilder struct {
	...
	defaults []*objectFunction
}

// NewDefaulterBuilder creates a new DefaulterBuilder for the given object type.
func NewDefaulterBuilder(resourceName TypeName, o *ObjectType, idFactory IdentifierFactory) *DefaulterBuilder {
...
func (d *DefaulterBuilder) AddDefault(f *objectFunction) {
	if !d.objectType.Equals(f.o) {
...
func (d *DefaulterBuilder) localDefault(k *objectFunction, codeGenerationContext *CodeGenerationContext, receiver TypeName, methodName string) *dst.FuncDecl {
...
func (d *DefaulterBuilder) defaultFunction(k *objectFunction, codeGenerationContext *CodeGenerationContext, receiver TypeName, methodName string) *dst.FuncDecl {
	receiverIdent := k.idFactory.CreateIdentifier(receiver.Name(), NotExported)
	receiverType := receiver.AsType(codeGenerationContext)
	tempVarIdent := "temp"
